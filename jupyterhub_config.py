...
#c.JupyterHub.admin_users = ['jakemg']
...
#c.JupyterHub.api_tokens = {
 	#"8ecaafb4b0426b764a5cf5c96aa503956c937b04aade80f93b0c2e2a4734a759":'jakegergen'
 	#}
...
#c.JupyterHub.data_files_path = '/home/jakegergen/.local/share/jupyterhub'
...
#c.JupyterHub.hub_ip = '10.0.0.255'
...
#ATTEMPTING TO FIX THE ERROR CASE WHEN TRYING TO RUN TWO USER SERVERS AT ONCE,
#most likely cause is that the second user trying to run his/her server
#does not have read/write access because they are not root user
#so this is a solution i found at https://github.com/jupyterhub/jupyterhub/issues/1527
#given by "rcasey-iris"
#one more change to be made at c.Spawner.cmd
...
c.Authenticator.admin_users = set(['jakegergen'])
